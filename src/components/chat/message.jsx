      ...
      <div className="mt-6 mx-auto max-w-screen-lg">
        <form onSubmit={handleSubmit}>
          <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 bg-white px-3 py-2">
            ...
            <button
              type="button"
              className="inline-block text-gray-700 focus:relative"
            >
            ...
            <textarea
              id="chat"
              rows="1"
              className="block p-2.5 w-full text-sm text-gray-900 border-0 bg-transparent focus:ring-0 focus:border-none resize-none outline-none"
